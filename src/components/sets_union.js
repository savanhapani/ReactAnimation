...
class Animation extends Component {
  animate = () => {
    ...
    for (let p = 0; p < 10; p = p + 1) {
      animation.to(this.set_img1, 0.01, { x: -p, y: 0, scale: 1.02 });
      animation.to(this.set_img2, 0.01, { x: 0, y: 0, scale: 1.02 });
      animation.to(this.set_img3, 0.01, { x: p, y: 0, scale: 1.02 });
    ...
    for (let q = 0; q < 10; q = q + 1) {
      animation.to(this.set_img1, 0.01, { x: -10 + q, y: 0, scale: 1.0 });
      animation.to(this.set_img2, 0.01, { x: 0, y: 0, scale: 1.0 });
      animation.to(this.set_img3, 0.01, { x: 10 - q, y: 0, scale: 1.0 });
    ...
    animation
      ...
      .to(this.box23, 1, { x: -20, y: 337 })
      .to(this.box46, 1, { x: -20, y: 337 })
      .to(this.box65, 1, { x: -20, y: 337 })
      .to(this.box88, 1, { x: -20, y: 337 })
      .to(this.box93, 1, { x: -20, y: 337 })
      .to(this.box9, 1, { x: -663, y: 337 })
      .to(this.box17, 1, { x: -663, y: 337 })
      .to(this.box47, 1, { x: -700, y: 337 });
  };
        ...
        <div style={styles.container}>
          <div className="con1">
            ...
            <div className="main_set_re">
              ...
              <div className="box_set4_union">}</div>
            </div>

...
class Animation extends Component {
  animate = () => {
    ...
    for (let p = 0; p < 50; p = p + 1) {
      animation.to(this.set_img1, 0.01, { x: -p, y: 0 });
    ...
    animation
      .to(this.set_img1, 0, { x: -40, y: -10000 })
      ...
      .to(this.box11, 0, { x: -40, y: -10000 })
      .to(this.box46, 0, { x: -80, y: -10000 })
      .to(this.box65, 0, { x: -80, y: -10000 })
      .to(this.box93, 0, { x: -118, y: -10000 })

      .to(this.box23_2, 0, { x: -140, y: -10000 })
      .to(this.box88_2, 0, { x: -180, y: -10000 })
      .to(this.box23, 1, { x: -50, y: 337 })
      .to(this.box88, 1, { x: -120, y: 337 });
  };

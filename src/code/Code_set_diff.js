...
<div>
            <div id="myDIV1" class="column textarea2">
              ...
              <p>
             <br/> void stl_set_difference_example()&#123;
  ...
  <br/>vector&#60;int&#62; D(100); 
  <br/>vector&#60;int&#62;::iterator id =  set_difference(x.begin(),x.end(),y.begin(),y.end(),D.begin());
 <br/> D.resize(id-D.begin());
  <br/>cout &#60;&#60; "SET Diffrence \n";
  <br/>display(D.begin(),D.end());
&#125;
